...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("summoners_name"));
            bindPreferenceSummaryToValue(findPreference("scan_interval"));
            bindPreferenceSummaryToValue(findPreference("server"));
            bindPreferenceSummaryToValue(findPreference("lol_version"));
